...
{
    public partial class fmdb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Specialization_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_Specializations_Specialization_id",
                        column: x => x.Specialization_id,
                        principalTable: "Specializations",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RepAnswers_Answers_Answer_id",
                        column: x => x.Answer_id,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RepAnswers_Users_User_id",
                        column: x => x.User_id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepAnswerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Likes_RepAnswers_RepAnswerId",
                        column: x => x.RepAnswerId,
                        principalTable: "RepAnswers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_Specialization_id",
                table: "Questions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepAnswers_Answer_id",
                table: "RepAnswers",
                column: "Answer_id");

            migrationBuilder.CreateIndex(
                name: "IX_RepAnswers_User_id",
                table: "RepAnswers",
                column: "User_id");
